...
input_filenames= r'C:\Users\maxma\Desktop\PROJECT\mapG.csv'
# input_filenames= r'C:\Users\maxma\Desktop\PROJECT\mapG_new.csv'
...
# define number of labels and initialize the model 
    ...
    pretraining_model.fit(np.stack(x_train['udps.stnn_image'],axis=0),
                        [np.stack(y_train)],
                        epochs=30,      
